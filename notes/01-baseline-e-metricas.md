...
- **DUDE** — *multi-page, multi-domain* (Van Landeghem et al., 2023). PDFs completos renderizados em imagens de página + query em linguagem natural + resposta livre + evidência por página. Domínios: científico, financeiro, legal, manuais, apresentações. Métrica: ANLS. [arxiv 2603.23511; proceedings.neurips 2024 MMLongBench-Doc]
